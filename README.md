...
[NeRF](http://www.matthewtancik.com/nerf) (Neural Radiance Fields) is a method that achieves state-of-the-art results for synthesizing novel views of complex scenes. Here are some videos generated by the original repository (pre-trained models are provided below):
...
This project is a CS231A Class Project Implementation of STaR : https://wentaoyuan.github.io/star/ implemented in pytorch heavily using the nerf-pytorch [repo](https://github.com/yenchenlin/nerf-pytorch)

## Installation

```
git clone https://github.com/tanwars/nerf-star
cd nerf-star
...
Download data example dataset: `lego_ball`

To train a low-res `lego_ball` NeRF:
```
python run_nerf_star.py --config configs/lego_ball.txt
```
After training for 100k iterations (~4 hours on a single 2080 Ti), you can find the following video at `logs/lego_test/lego_ball_test_spiral_100000_rgb.mp4`.
<!-- 
