...
def raw2outputs(raw_stat, raw_dyna, z_vals, rays_d_s, rays_d_d, raw_noise_std=0, white_bkgd=False, pytest=False):
    ...
    return rgb_map, disp_map, acc_map, weights, depth_map, model_outputs_stat, model_outputs_dyna
...
#     raw = run_network(pts)
    ...
    rgb_map, disp_map, acc_map, weights, depth_map, model_outputs_stat, model_outputs_dyna = raw2outputs(raw_stat, raw_dyna, z_vals, rays_d_s, rays_d_d, raw_noise_std, white_bkgd, pytest=pytest)
